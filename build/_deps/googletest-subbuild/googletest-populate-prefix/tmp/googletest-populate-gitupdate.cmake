...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git show-ref "v1.15.0"
  WORKING_DIRECTORY "F:/OOP/OOP_lab_03/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'F:/OOP/OOP_lab_03/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/OOP/OOP_lab_03/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
